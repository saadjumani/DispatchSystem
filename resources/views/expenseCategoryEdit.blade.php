                ...
                <section class="content">
                    <div class="row">
                        ...
                        <div class="panel-body">
                                ...
                                {!! Form::open(['action'=> ['expensesController@update', $data->id], 'method'=>'POST'], ['class'=>'col-sm-10']) !!}
                            ...
                            <tr>
                                <td>
	                                <div  class="col-sm-10 form-group">
	                                    ...
	                                    {{ Form::text('expenseCategory', $data->expenseCategory, ['class' => "form-control", 'placeholder' => "Enter maintenance type"]) }}

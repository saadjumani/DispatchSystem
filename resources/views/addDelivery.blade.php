                        ...
                        <div class="col-sm-12 lobipanel-parent-sortable ui-sortable" data-lobipanel-child-inner-id="ekiAi16e04">
                            <div class="panel panel-bd lobidrag lobipanel lobipanel-sortable" data-inner-id="ekiAi16e04" data-index="0">
                                ...
                                <div class="panel-body">
                                    {!! Form::open(['action'=> 'deliveriesController@store', 'method'=>'POST'], ['class'=>'col-sm-10']) !!}
									...
									<tbody><tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                                ...
                                                {{ Form::select('customerType', ['Direct Customer'=>'Direct Customer', '3PL'=>'3PL', 'Broker'=>'Broker'], '', ['class'=>'form-control', 'placeholder'=>"Enter Guardian Name"]) }}
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('motorCarrierNo', '', ['class' => "form-control", 'placeholder' => "Enter Motor Carrier No"]) }}
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('taxID', '', ['class' => "form-control", 'placeholder' => "Enter Tax ID"]) }}
								...
								<tr>
									 <td colspan="2"><div class="col-sm-11 form-group">
                                                <label>Note</label>
                                                {{Form::textarea('comments', '', ['class'=>'form-control', 'rows'=>'4', 'placeholder'=>'Enter text ...'])}}  
                                            </div> 

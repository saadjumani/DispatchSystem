                ...
                <section class="content">
                    <div class="row">
                        ...
                        <div class="col-sm-12 lobipanel-parent-sortable ui-sortable" data-lobipanel-child-inner-id="Nbuw85x7j4">
                            <div class="panel panel-bd lobidrag lobipanel lobipanel-sortable" data-inner-id="Nbuw85x7j4" data-index="0">
                                <div class="panel-heading ui-sortable-handle">
                                    <div class="btn-group"> 
                                       <a style="background-color:#26a69a; border-color: #26a69a" class="btn btn-primary" href="/expenseCategory/"> <i class="fa fa-plus"></i> View Expense Category</a>  
                                  </div>
                        ...
                        <div class="panel-body">
                                ...
                                {!! Form::open(['action'=> 'expensesController@store', 'method'=>'POST'], ['class'=>'col-sm-6']) !!}
                            ...
                            <tr>
                                <td>
	                                <div  class="col-sm-10 form-group">
	                                    ...
	                                    {{ Form::text('expenseCategory', '', ['class' => "form-control", 'placeholder' => "Enter expense type"]) }}

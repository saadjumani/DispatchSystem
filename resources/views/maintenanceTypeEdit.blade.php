                ...
                <section class="content">
                    <div class="row">
                        ...
                        <div class="panel-body">
                                ...
                                {!! Form::open(['action'=> ['maintenanceTypesController@update', $data->id], 'method'=>'POST'], ['class'=>'col-sm-10']) !!}
                            ...
                            <tr>
                                <td>
	                                <div  class="col-sm-10 form-group">
	                                    ...
	                                    {{ Form::text('maintenanceType', $data->maintenanceType, ['class' => "form-control", 'placeholder' => "Enter maintenance type"]) }}

			...
			<div class="content-wrapper">
				...
				<section class="container-fluid">
                    <div class="row">
	                            ...
	                            <div class="panel panel-bd cardbox">
	                                <div class="panel-body">
	                                    <div class="items text-center">
	                                        <i style="padding-top: 4px; font-size: 23px" class="hvr-buzz-out fa fa-fw glyphicon glyphicon-paste fa-2x"></i>
	                                        <h4> Dispatch</h4>
	                                    </div>
	                                </div>
	                            </div>
	                    ...
	                    <a href="driver">
	                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-3">
	                            <div class="panel panel-bd cardbox">
	                                <div class="panel-body">
	                                    <div class="items text-center">
	                                        <i class="hvr-buzz-out fa fa-user-plus fa-2x"></i>
	                                        <h4>Drivers</h4>
	                                    </div>
	                                </div>
	                            </div>
						...
						<a href="maintenanceType">
	                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-3">
	                            <div class="panel panel-bd cardbox">
	                                <div class="panel-body">
	                                    <div class="items text-center">
	                                        <i class="fa fa-fw fa fa-briefcase fa-2x"></i>
	                    ...
	                    <a href="customer">
	                        ...
	                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-3">
	                            <div class="panel panel-bd cardbox">
	                                <div class="panel-body">
	                                    <div class="items text-center">
	                                        <i class="fa fa-fw fa-street-view fa-2x"></i>
	                                        <h4> Statements</h4>
	                                    </div>
	                                </div>
	                            </div>
	                        ...
	                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-3">
	                            <div class="panel panel-bd cardbox">
	                                <div class="panel-body">
	                                    <div class="items text-center">
	                                    <i class="hvr-buzz-out fa fa-fw fa-home fa-2x"></i>
	                                    <h4>Invoice</h4>
	                                    </div>
	                                </div>
	                            </div>
	                        </div>
	                    <a href="expenseCategory">
	                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-3">
	                            <div class="panel panel-bd cardbox">
	                                <div class="panel-body">
	                                    <div class="items text-center">
	                                    <i class="fa fa-fw fa-minus-square-o fa-2x"></i>
	                                    <h4>Expenses</h4>
	                                    </div>
	                                </div>
	                            </div>
	                    ...
	                    <a href="truck">
	                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-3">
	                            <div class="panel panel-bd cardbox">
	                                <div class="panel-body">
	                                    <div class="items text-center">
	                                    <i class="hvr-buzz-out fa fa-fw fa-truck fa-2x"></i>
	                                    <h4>Trucks</h4>
	                                    </div>
	                                </div>
	                            </div>

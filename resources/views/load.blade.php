				...
				<!-- /page header -->
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="table-responsive">
                                            <table class="table table-bordered table-hover" >
                                                <thead class="success text-semibold">
                                                    <tr>
                                                        <th>Load#</th>
                                                        <th>Pickup</th>
                                                        <th>Delivery</th>
                                                ...
                                                <tbody>
                                                    <tr>  
                                                     <td>
                                                         <label class="b">10019</label>   
                                                     </td>
                                                     <td>04/18/17</td>
                                                     <td>04/22/17</td>
                                                     <td><a href="http://testlayout.net/admin/view_driver.php%3E">Baker</a></td>
                                                     <td>55</td>
													 <td>Chicago, IL</td>
													 <td>Las Vegas, NV</td>
													 <td>LK521-33621</td>
                                                ...
                                                <tr>
                                                    <td>
                                                       <label class="b">10282</label>   
                                                   </td>
                                                   <td>05/18/17</td>
                                                   <td>05/25/17</td>
                                                    <td><a href="http://testlayout.net/admin/view_driver.php%3E">Adams</a></td>
                                                     <td>45</td>
                    ...
                    <div class="page-nation text-right">
                        <ul class="pagination pagination-large">
                            ...
                            <li><a href="http://testlayout.net/admin/view_load.php#">2</a></li>
                            <li class="disabled"><span>...</span></li><li>
                            </li><li><a rel="next" href="http://testlayout.net/admin/view_load.php#">Next</a></li>
                        </ul>
                    </div>

                        ...
                        <div class="col-sm-12 lobipanel-parent-sortable ui-sortable" data-lobipanel-child-inner-id="RidyzuSl7W">
                            <div class="panel panel-bd lobidrag lobipanel lobipanel-sortable" data-inner-id="RidyzuSl7W" data-index="0">
                                <div class="panel-heading ui-sortable-handle">
                                    <div class="btn-group"> 
                                        <a style="background-color:#26a69a; border-color: #26a69a" class="btn btn-primary" href="/driver/"> <i class="fa fa-plus"></i> View Driver</a>  
                                    </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    {!! Form::open(['action'=> ['driversController@update', $data->id], 'method'=>'POST'], ['class'=>'col-sm-10']) !!}
									...
									<td bgcolor=""><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('firstName', $data->firstName, ['class' => "form-control", 'placeholder' => "Enter First Name"]) }}

                                            </div></td>
									<td bgcolor=""><div class="col-sm-10 form-group">
                                                <label>Last Name<font color="red">*</font></label>

                                               {{ Form::text('lastName', $data->lastName, ['class' => "form-control", 'placeholder' => "Enter Last Name"]) }}
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('streetNo', $data->streetNo, ['class' => "form-control", 'placeholder' => "Enter Street"]) }}

                                            </div></td>

    
                                          <td><div class="col-sm-10 form-group">
                                                <label>Apt/Suite/Other<font color="red"></font></label>

                                               {{ Form::text('aptOrSuiteOrOther', $data->aptOrSuiteOrOther, ['class' => "form-control", 'placeholder' => "Enter Apt/Suite/Other"]) }}
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('city', $data->city, ['class' => "form-control", 'placeholder' => "Enter city"]) }}
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('state', $data->state, ['class' => "form-control", 'placeholder' => "Enter state"]) }}
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('zipCode', $data->zipCode, ['class' => "form-control", 'placeholder' => "Enter Zip code"]) }}
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('phoneNo', $data->phoneNo, ['class' => "form-control", 'placeholder' => "Enter Phone no."]) }}
										...
										<td bgcolor=""><div class="col-sm-10 form-group">
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                                <label>Default Payment Type<font color="red">*</font></label>
													{{Form::select('paymentType', ['Manual Pay'=>'Manual Pay', 'Pay per mile'=>'Pay per mile', 'Contract'=>'Contract'], $data->paymentType, ['class'=>'form-control', 'placeholder'=>"Default Payment Type"])}}
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                               <label>License Expiration <font color="red"></font></label>
                                                 <div class="input-group date">
                                                   <div class="input-group-addon">
                                                     <i class="fa fa-calendar"></i>
                                                    </div>
                                                    {{ Form::date('licenseExpireDate', $data->licenseExpireDate, ['class' => "form-control pull-right", 'id'=>"date_reported"])}}
                                                   </div>
                                            </div>
									  ...
									  <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                               <label>Medical Card Renewal<font color="red"> </font></label>
                                                 <div class="input-group date">
                                                   <div class="input-group-addon">
                                                     <i class="fa fa-calendar"></i>
                                                    </div>
                                                    {{ Form::date('medicalCardRenewal', $data->medicalCardRenewal, ['class' => "form-control pull-right", 'id'=>"date_reported"])}}
                                                   </div>
                                            </div>
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                               <label>Hire Date <font color="red"> </font></label>
                                                 <div class="input-group date">
                                                   <div class="input-group-addon">
                                                     <i class="fa fa-calendar"></i>
                                                    </div>
                                                    {{ Form::date('hireDate', $data->hireDate, ['class' => "form-control pull-right", 'id'=>"date_reported"])}}
                                                   </div>
                                            </div></td>

    
                                          <td><div class="col-sm-10 form-group">
                                               <label>Termination Date <font color="red"> </font></label>
                                                 <div class="input-group date">
                                                   <div class="input-group-addon">
                                                     <i class="fa fa-calendar"></i>
                                                    </div>
                                                    {{ Form::date('terminationDate', $data->terminationDate, ['class' => "form-control pull-right", 'id'=>"date_reported"])}}
                                                   </div>
                                            </div>
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('emergencyContactName', $data->emergencyContactName, ['class' => "form-control", 'placeholder' => "Enter Person Name ."]) }}
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('emergencyPhoneNo', $data->emergencyPhoneNo, ['class' => "form-control", 'placeholder' => "Enter Person No."]) }}

                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="btn-group"> 
                                            <a style="background-color:#26a69a" class="btn btn-success" href="\load"> <i class="fa fa-fw fa-plus-square"></i>  View Load</a>  
                                        </div>
                                    </div>
                                    <div class="panel-body">
										...
										<tbody><tr> <td colspan="2" bgcolor="#26a69a"> <strong><font color="white">Basic Details</font> </strong></td> </tr>
										<tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                                {{Form::label('title', 'Custom Load Number')}}
                                                {{Form::number('name', '', ['class'=>'form-control', 'placeholder'=>'00001'])}}
                                            </div></td>

    
                                          <td><div class="col-sm-8 form-group">
                                                <label>Customer Name <font color="red">*</font></label>
                                               <select name="p_id" id="p_id" class="form-control" placeholder="Enter Guardian Name">
                                                  <option value="0"> Dell Inc, Minneapolis, MN</option>
                                                  <option value="0"> Dell Inc, Wisconsin, WI</option>
                                                  <option value="0"> Dell Inc, Ohio, MN</option>

                                                </select> </div> <div> <label></label><br>
												<a style="background-color:#26a69a" class="btn btn-success" href="/customer/create"> <i class="fa fa-fw fa-plus-circle"></i> Quick Add</a></div>
											</td> 
                                     </tr>
									 
									  <tr>
										<td bgcolor=""><div class="col-sm-8 form-group">
                                                 <label>Driver <font color="red">*</font></label>
                                               <select name="p_id" id="p_id" class="form-control" placeholder="Enter Guardian Name">
                                                  <option value="0"> Ali</option>
                                                  <option value="0"> Mohamed</option>
                                                  <option value="0"> Jama Ahmed</option>

                                                </select> </div> <div> <label></label><br>
												<a style="background-color:#26a69a" class="btn btn-success" href="/driver/create"> <i class="fa fa-fw fa-plus-circle"></i>Quick Add</a></div></td>

    
                                          <td><div class="col-sm-8 form-group">
                                                 <label>Truck <font color="red">*</font></label>
                                               <select name="p_id" id="p_id" class="form-control" placeholder="Enter Guardian Name">
                                                  <option value="0"> 155</option>
                                                  <option value="0"> 902</option>
                                                  <option value="0"> 852</option>

                                                </select> </div> <div> <label></label><br>
												<a style="background-color:#26a69a" class="btn btn-success" href="/truck/create"> <i class="fa fa-fw fa-plus-circle"></i>Quick Add</a></div>
											</td> 
                                     </tr>
									 <tr> <td colspan="2" bgcolor="#26a69a"> <strong><font color="white">Pickup</font> </strong></td> </tr>
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-8 form-group">
                                               ...
                                               <select name="p_id" id="p_id" class="form-control" placeholder="Enter Guardian Name">
                                                  <option value="0"> Dell Inc, Minneapolis, MN</option>
                                                  <option value="0"> HP Inc, Wisconsin, WI</option>
                                                  <option value="0"> Toshiba Inc, Ohio, MN</option>

                                                </select> </div> <div> <label></label><br>
												<a style="background-color:#26a69a" class="btn btn-success" href="/shipper/create"> <i class="fa fa-fw fa-plus-circle"></i>Quick Add</a></div></td>
                                               ...
                                               <label>Pickup Date <font color="red">*</font></label>
                                                 <div class="input-group date">
                                                   <div class="input-group-addon">
                                                    ...
                                                    <input type="date" name="dob" class="form-control pull-right" id="date_reported" required="">
                                                   </div>
                                            </div>
											</td> 
                                     </tr>
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                                <label>BOL</label>
                                                 <input type="text" name="registratin_fee" class="form-control" placeholder="Enter bill of lading" required="">
                                                    
												</div></td>
                                          <td><div class="col-sm-10 form-group">
                                                <label>Customer Required Info</label>
                                                <input type="text" name="registratin_fee" class="form-control" placeholder="Enter Customer Required Infog" required="">
											</div></td> 
                                     </tr>
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                                <label>Weight</label>
                                                 <input type="text" name="registratin_fee" class="form-control" placeholder="Enter Weight" required="">
                                          ...
                                          <td><div class="col-sm-8 form-group">
                                               ...
                                               <input type="text" name="registratin_fee" class="form-control" placeholder="Enter Quantity" required="">
											   </div> <div> <label></label><br>
												 <select name="p_id" id="p_id" placeholder="Enter Guardian Name">
                                                  <option value="0">  Barrels</option>
                                                  <option value="0"> Boxes</option>
                                                  <option value="0"> Bushels</option>
												  <option value="0"> Cases</option>
												  <option value="0"> Crates</option>
												  <option value="0"> Gallons</option>
                                     ...
                                     <label>Note</label><br>
                                     <textarea class="form-control" rows="1" placeholder="problem">                                     </textarea>
                                 </div>
											</td> 
                                     </tr>
									 <tr> <td colspan="2" bgcolor="#26a69a"> <strong><font color="white">Delivery</font> </strong></td> </tr>
									 
									 <tr>
										<td bgcolor=""><div class="col-sm-8 form-group">
                                                 <label>Consignee <font color="red">*</font></label>
                                               <select name="p_id" id="p_id" class="form-control" placeholder="Enter Consignee">
                                                  <option value="0"> ASSER ABC Inc, Minneapolis, MN</option>
                                                  <option value="0"> HP Inc, Wisconsin, WI</option>
                                                  <option value="0"> Toshiba Inc, Ohio, MN</option>

                                                </select> </div> <div> <label></label><br>
												<a style="background-color:#26a69a" class="btn btn-success" href="/delivery/create"> <i class="fa fa-fw fa-plus-circle"></i>Quick Add</a></div></td>
									  ...
									  <tr> <td colspan="2" bgcolor="#26a69a"> <strong><font color="white">Fees / Charges </font> </strong></td> </tr>
									 
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                                 <label>Primary Fee </label>
                                                 <input type="text" name="registratin_fee" class="form-control" placeholder="$ 0.00" required="">
											   </div></td>

    
                                          <td><div class="col-sm-10 form-group">
                                               <label>Primary Fee Type</label>
                                                 <select name="p_id" id="p_id" class="form-control" placeholder="Enter Guardian Name">
                                                  <option value="0">  Flat Fee</option>
                                                  <option value="0"> Per Mile</option>
                                                  <option value="0"> Per Hundred Weight (cwt)</option>
												  <option value="0"> Per Ton</option>
												  <option value="0"> Per Quantity</option>
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                                 <label>FSC Amount </label>
                                                 <input type="text" name="registratin_fee" class="form-control" placeholder="$ 0.00" required="">
											   </div></td>

    
                                          <td><div class="col-sm-10 form-group">
                                               <label>FSC Amount Type</label>
                                                 <select name="p_id" id="p_id" class="form-control" placeholder="Enter Guardian Name">
                                                  <option value="0">  Flat Fee</option>
                                                  <option value="0"> Per Mile</option>
									 ...
									 <tr> <td colspan="2" bgcolor="#26a69a"> <strong><font color="white">Accessory Fees </font> </strong></td> </tr>
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                          ...
                                          <td><div class="col-sm-10 form-group">
										   ...
										   <tr>
										   <td colspan="2"> <div class="col-sm-10 reset-button">
                                                 <button style="background-color:#26a69a" type="submit" class="btn btn-success">Submit</button>
												  <button style="background-color:#26a69a" type="#" class="btn btn-success">Reset</button>

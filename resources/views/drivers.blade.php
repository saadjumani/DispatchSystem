                        ...
                        <div class="col-sm-12 lobipanel-parent-sortable ui-sortable" data-lobipanel-child-inner-id="cpa90TSeTV">
                            <div class="panel panel-bd lobidrag lobipanel lobipanel-sortable" data-inner-id="cpa90TSeTV" data-index="0">
                                <div class="panel-heading ui-sortable-handle">
                                    <div class="btn-group"> 
                                       <a style="background-color:#26a69a; border-color: #26a69a"  class="btn btn-success" href="driver/create"> <i class="fa fa-plus"></i> Add Driver</a> 
                                    </div>
                        ...
                        @if($data)
							@foreach($data as $rrr)
								<tr style="text-align: center;">
									...
									<td>
										{{$rrr->licenseExpireDate}}
									</td>
									<td>
										{{$rrr->licenseIssuingState}}
									</td>
									<td>
										{{$rrr->medicalCardRenewal}}
									</td>
									<td>
										{{$rrr->hireDate}}
									</td>
									...
									<td>
										{{$rrr->emergencyContactName}} ({{$rrr->emergencyPhoneNo}})
									</td>
									<td>
                                       <a href="/driver/{{$rrr->id}}/edit" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                        
                                       {!! Form::open(['action'=> ['driversController@destroy',$rrr->id], 'method'=>'POST'], ['class'=>'col-sm-6']) !!}
                                       <button href="/driver/{{$rrr->id}}/destroy" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="right" title="Delete">

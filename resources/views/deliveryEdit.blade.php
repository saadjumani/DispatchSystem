                        ...
                        <div class="col-sm-12 lobipanel-parent-sortable ui-sortable" data-lobipanel-child-inner-id="ekiAi16e04">
                            <div class="panel panel-bd lobidrag lobipanel lobipanel-sortable" data-inner-id="ekiAi16e04" data-index="0">
                                <div class="panel-heading ui-sortable-handle">
                                    <div class="btn-group"> 
                                        <a style="background-color:#26a69a; border-color: #26a69a" class="btn btn-primary" href="/delivery/"> <i class="fa fa-plus"></i> View delivery</a>  
                                    </div>
                                ...
                                <div class="panel-body">
                                    {!! Form::open(['action'=> ['deliveriesController@update', $data->id], 'method'=>'POST'], ['class'=>'col-sm-10']) !!}
									...
									<tbody><tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('companyName', $data->companyName, ['class' => "form-control", 'placeholder' => "Enter Company Name"]) }}

                                            </div></td>
                                          <td><div class="col-sm-10 form-group">
                                                <label>Customer Type<font color="red">*</font></label>

                                                {{ Form::select('customerType', ['Direct Customer'=>'Direct Customer', '3PL'=>'3PL', 'Broker'=>'Broker'], $data->customerType, ['class'=>'form-control', 'placeholder'=>"Enter Guardian Name"]) }}
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('website', $data->website, ['class' => "form-control", 'placeholder' => "Enter Website"]) }}
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                                <label>Motor Carrier Number<font color="red"></font></label>

                                               {{ Form::text('motorCarrierNo', $data->motorCarrierNo, ['class' => "form-control", 'placeholder' => "Enter Motor Carrier No"]) }}

                                            </div></td>

    
                                          <td><div class="col-sm-10 form-group">
                                                <label>Tax ID (EIN#)<font color="red"></font></label>

                                               {{ Form::text('taxID', $data->taxID, ['class' => "form-control", 'placeholder' => "Enter Tax ID"]) }}
								...
								<tr>
									 <td colspan="2"><div class="col-sm-11 form-group">
                                                <label>Note</label>
                                                {{Form::textarea('comments', $data->comments, ['class'=>'form-control', 'rows'=>'4', 'placeholder'=>'Enter text ...'])}}  
                                            </div> 

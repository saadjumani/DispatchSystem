                        ...
                        <div class="col-sm-12 lobipanel-parent-sortable ui-sortable" data-lobipanel-child-inner-id="RidyzuSl7W">
                            <div class="panel panel-bd lobidrag lobipanel lobipanel-sortable" data-inner-id="RidyzuSl7W" data-index="0">
                                ...
                                <div class="panel-body">
                                     ...
                                     {!! Form::open(['action'=> 'driversController@store', 'method'=>'POST'], ['class'=>'col-sm-10']) !!}
									...
									<td bgcolor=""><div class="col-sm-10 form-group">
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('streetNo', '', ['class' => "form-control", 'placeholder' => "Enter Street"]) }}
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('aptOrSuiteOrOther', '', ['class' => "form-control", 'placeholder' => "Enter Apt/Suite/Other"]) }}
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('phoneNo', '', ['class' => "form-control", 'placeholder' => "Enter Phone no."]) }}
										...
										<td bgcolor=""><div class="col-sm-10 form-group">
                                          ...
                                          <td><div class="col-sm-10 form-group">
                                                <label>Default Payment Type<font color="red">*</font></label>
													{{Form::select('paymentType', ['Manual Pay'=>'Manual Pay', 'Pay per mile'=>'Pay per mile', 'Contract'=>'Contract'], null, ['class'=>'form-control', 'placeholder'=>"Default Payment Type"])}}
									 ...
									 <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('licenseNo', '', ['class' => "form-control", 'placeholder' => "Enter license No"]) }}
                                               ...
                                               <label>License Expiration <font color="red"></font></label>
                                                 <div class="input-group date">
                                                   <div class="input-group-addon">
                                                    ...
                                                    {{ Form::date('licenseExpireDate', \Carbon\Carbon::now(), ['class' => "form-control pull-right", 'id'=>"date_reported"])}}
                                                   </div>
                                            </div>
									  ...
									  <tr>
										<td bgcolor=""><div class="col-sm-10 form-group">
                                                ...
                                                {{ Form::text('licenseIssuingState', '', ['class' => "form-control", 'placeholder' => "Enter License Issuing state."]) }}
                                               ...
                                               <label>Medical Card Renewal<font color="red"> </font></label>
                                                 <div class="input-group date">
                                                   <div class="input-group-addon">
                                                    ...
                                                    {{ Form::date('medicalCardRenewal', \Carbon\Carbon::now(), ['class' => "form-control pull-right", 'id'=>"date_reported"])}}
                                                   </div>
                                            </div>
                                               ...
                                               <label>Hire Date <font color="red"> </font></label>
                                                 <div class="input-group date">
                                                   <div class="input-group-addon">
                                                    ...
                                                    {{ Form::date('hireDate', \Carbon\Carbon::now(), ['class' => "form-control pull-right", 'id'=>"date_reported"])}}
                                                   </div>
                                            </div></td>
                                               ...
                                               <label>Termination Date <font color="red"> </font></label>
                                                 <div class="input-group date">
                                                   <div class="input-group-addon">
                                                    ...
                                                    {{ Form::date('terminationDate', \Carbon\Carbon::now(), ['class' => "form-control pull-right", 'id'=>"date_reported"])}}
                                                   </div>
                                            </div>
									 ...
									 <tr>
										<td >
											<div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('emergencyContactName', '', ['class' => "form-control", 'placeholder' => "Enter Person Name ."]) }}
                                          ...
                                          <td>
                                          	<div class="col-sm-10 form-group">
                                               ...
                                               {{ Form::text('emergencyPhoneNo', '', ['class' => "form-control", 'placeholder' => "Enter Person No."]) }}

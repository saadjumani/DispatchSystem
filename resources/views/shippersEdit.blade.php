                        ...
                        <div class="col-sm-12 lobipanel-parent-sortable ui-sortable" data-lobipanel-child-inner-id="ekiAi16e04">
                            <div class="panel panel-bd lobidrag lobipanel lobipanel-sortable" data-inner-id="ekiAi16e04" data-index="0">
                                <div class="panel-heading ui-sortable-handle">
                                    <div class="btn-group"> 
                                        <a style="background-color:#26a69a; border-color: #26a69a" class="btn btn-primary" href="/shipper/"> <i class="fa fa-plus"></i> View Shipper</a>  
                                    </div>
                                ...
                                <div class="panel-body">
                                    {!! Form::open(['action'=> ['shippersController@update', $data->id], 'method'=>'POST'], ['class'=>'col-sm-10']) !!}

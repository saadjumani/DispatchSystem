                        ...
                        <div class="col-sm-12 lobipanel-parent-sortable ui-sortable" data-lobipanel-child-inner-id="0Wzzshtxdz">
                            <div class="panel panel-bd lobidrag lobipanel lobipanel-sortable" data-inner-id="0Wzzshtxdz" data-index="0">
                                <div class="panel-heading ui-sortable-handle">
                                    <div class="btn-group"> 
                                       <a style="background-color:#26a69a; border-color: #26a69a" class="btn btn-success" href="/expenseCategory/create"> <i class="fa fa-plus"></i> Add Expense Category</a> 
                                    </div>
                        ...
                        @if($data)
							@foreach($data as $rrr)
								<tr style="text-align: center;">
									...
									<td >
                                       <a href="/expenseCategory/{{$rrr->id}}/edit" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="left" title="Update">
                                       	<i class="fa fa-pencil" aria-hidden="true"></i>
                                       </a>
                                        
                                       {!! Form::open(['action'=> ['expensesController@destroy',$rrr->id], 'method'=>'POST'], []) !!}

                                       <button href="/expenseCategory/{{$rrr->id}}/destroy" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="right" title="Delete">
